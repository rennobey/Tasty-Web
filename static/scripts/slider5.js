const wrapper5 = document.querySelector(".slider-5");
const carousel5 = document.querySelector(".carousel-slider4");
const firstCardWidth5 = carousel5.querySelector(".card-4").offsetWidth;
const arrowBtns5 = document.querySelectorAll(".slider-5 i");
const carouselChildrens5 = [...carousel5.children];

let isDragging5 = false, isAutoPlay5 = true, startX5, startScrollLeft5, timeoutId5;
...
carousel5.classList.add("no-transition5");
carousel5.scrollLeft = carousel5.offsetWidth;
carousel5.classList.remove("no-transition5");

// Add event listeners for the arrow buttons to scroll the carousel left and right
arrowBtns5.forEach(btn => {
    btn.addEventListener("click", () => {
        carousel5.scrollLeft += btn.id == "left4" ? -firstCardWidth5 : firstCardWidth5;
    });
});
